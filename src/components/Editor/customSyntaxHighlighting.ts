...
export const customSyntaxHighlighting = (): HighlightStyle =>
  HighlightStyle.define([
    ...
    },
    {
      ...
      color:
        'var(--hybrid-mde-propertyName-definition, var(--hybrid-mde-propertyName, var(--hybrid-mde-name, #e06c75)))',
    },
    {
    ...
    },
    {
      ...
      color:
        'var(--hybrid-mde-variableName-definition, var(--hybrid-mde-variableName, var(--hybrid-mde-name, #e5c07b)))',
    },
    {
      tag: tags.local(tags.variableName),
      color:
        'var(--hybrid-mde-variableName-local, var(--hybrid-mde-variableName, var(--hybrid-mde-name, #d19a66)))',
    },
    {
      tag: tags.special(tags.variableName),
      color:
        'var(--hybrid-mde-variableName-special, var(--hybrid-mde-variableName, var(--hybrid-mde-name, inherit)))',
    },
    // headings
    {
      tag: tags.heading,
    ...
    },
    {
      ...
      color:
        'var(--hybrid-mde-string-special, var(--hybrid-mde-string, inherit))',
    },
    // emphasis types
    {
      tag: tags.emphasis,
